...
class Test_homepage:
    ...
    invalid_search = ReadConfig.getInvalidSearch()
    ...
    def test_invalid_search(self, setup):
        ...
        self.driver.maximize_window()
        self.driver.get(self.baseURL)
        self.driver.find_element_by_id("search_query_top").send_keys(self.invalid_search)
    ...
    def test_valid_search(self, setup):
        ...
        self.driver.find_element_by_id("search_query_top").send_keys(self.search)
        self.driver.find_element_by_xpath("//header/div[3]/div[1]/div[1]/div[2]/form[1]/button[1]").click()
